...
if __name__ == '__main__':
    ...
    train_img_names = [path.name for path in Path(TRAIN_DIR_IMG).glob('*.jpg')] + [path.name for path in Path(TRAIN_DIR_IMG).glob('*.png')]
    train_mask_names = [path.name for path in Path(TRAIN_DIR_MASK).glob('*.jpg')] + [path.name for path in Path(TRAIN_DIR_MASK).glob('*.png')]
